...
async function main() {
  ...
  assert(html.includes('index.css?v=20260708-cleanup-v4'), 'CSS cache version is stale');
  assert(html.includes('app.js?v=20260708-cleanup-v4'), 'Core JS cache version is stale');
  assert(html.includes('scripts/holosyn-timeline.js?v=20260708-cleanup-v4'), 'Timeline script tag is missing or stale');
  assert(html.includes('scripts/holosyn-pro-managers.js?v=20260708-cleanup-v4'), 'Pro managers script tag is missing or stale');
