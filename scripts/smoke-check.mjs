...
async function main() {
  ...
  assert(html.includes('index.css?v=20260824-forge'), 'CSS cache version is stale');
  assert(html.includes('app.js?v=20260824-forge'), 'Core JS cache version is stale');
  assert(html.includes('scripts/holosyn-timeline.js?v=20260824-forge'), 'Timeline script tag is missing or stale');
  assert(html.includes('scripts/holosyn-pro-managers.js?v=20260824-forge'), 'Pro managers script tag is missing or stale');
